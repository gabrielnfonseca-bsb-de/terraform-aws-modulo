...
| [kubernetes_service_account_v1.eks_service_account](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/service_account_v1) | resource |
...
| <a name="input_oidc"></a> [oidc](#input\_oidc) | HTTPS from OIDC provider of the EKS cluster | `string` | n/a | yes |
...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | ID of the VPC where the EKS cluster is running | `string` | n/a | yes |
